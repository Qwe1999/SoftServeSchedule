...
INSERT INTO information_schema.views (table_catalog, table_schema, table_name, view_definition, check_option, is_updatable, is_insertable_into, is_trigger_updatable, is_trigger_deletable, is_trigger_insertable_into) VALUES ('schedule', 'pg_catalog', 'pg_stat_progress_cluster', ' SELECT s.pid,
    s.datid,
    d.datname,
    s.relid,
        CASE s.param1
   ...
   FROM (pg_stat_get_progress_info(''CLUSTER''::text) s(pid, datid, relid, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20)
     LEFT JOIN pg_database d ON ((s.datid = d.oid)));', 'NONE', 'NO', 'NO', 'NO', 'NO', 'NO');
INSERT INTO information_schema.views (table_catalog, table_schema, table_name, view_definition, check_option, is_updatable, is_insertable_into, is_trigger_updatable, is_trigger_deletable, is_trigger_insertable_into) VALUES ('schedule', 'pg_catalog', 'pg_stat_progress_create_index', ' SELECT s.pid,
    s.datid,
    d.datname,
    s.relid,
...
INSERT INTO information_schema.views (table_catalog, table_schema, table_name, view_definition, check_option, is_updatable, is_insertable_into, is_trigger_updatable, is_trigger_deletable, is_trigger_insertable_into) VALUES ('schedule', 'pg_catalog', 'pg_stats_ext', ' SELECT cn.nspname AS schemaname,
    c.relname AS tablename,
...
INSERT INTO information_schema.views (table_catalog, table_schema, table_name, view_definition, check_option, is_updatable, is_insertable_into, is_trigger_updatable, is_trigger_deletable, is_trigger_insertable_into) VALUES ('schedule', 'pg_catalog', 'pg_stat_gssapi', ' SELECT s.pid,
...
INSERT INTO information_schema.views (table_catalog, table_schema, table_name, view_definition, check_option, is_updatable, is_insertable_into, is_trigger_updatable, is_trigger_deletable, is_trigger_insertable_into) VALUES ('schedule', 'information_schema', 'column_column_usage', ' SELECT (current_database())::information_schema.sql_identifier AS table_catalog,
